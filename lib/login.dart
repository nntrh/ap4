...
class _ConnectionState extends State<Connection> {
  ...
  void _handleLog() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Token stored in SharedPreferences: ${prefs.getString('token')}');
  ...
  obscureText: true,
  textInputAction: TextInputAction.done, // Définit l'action du clavier comme "Terminé"
  onSubmitted: (_) => _handleLog(), // Appelle la méthode _handleLog() lorsque l'utilisateur appuie sur "Terminé"
  decoration: InputDecoration(
    border: OutlineInputBorder(),
